...
if (isset($_POST['cusid'], $_POST['total'], $_POST['time'], $_POST['portal'], $_POST['distination'], $_POST['transactioncode'])) {
    $cusid = $_POST['cusid'];
    $total = $_POST['total'];
    $time = $_POST['time'];
    $portal = $_POST['portal'];
    ...
    // Set default values for charges
    $charge = $charge1 = 0;

    // Calculate charges based on conditions
    if ($portal == 'Pick-Up') {
        $charge = 0;
    }
    if ($portal == 'Delivery') {
    ...
    // Now you can use $cusid, $total, $time, $portal, $distination, $transactioncode, $charge, and $charge1 in your code.
} else {
    // Handle the case where required POST variables are not set
